...
<head>
  ...
  <title>Criar Conta-Cliente | SGHC</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">SGHC</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Preencha o formulário abaixo para prosseguires.</p>
                  </div>

                  <form class="row g-3 needs-validation form-post" novalidate>

                    <div class="col-12">
                      <label for="floarBI" class="form-label">Nº BI*</label>
                      <input type="text" name="numero_bi" class="form-control" id="floatBI" required>
                      <div class="invalid-feedback">Número de BI</div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Por favo forneça um email válido.</div>
                    </div>

                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Telefone *</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">+244</span>
                        <input type="text" name="telefone" class="form-control" id="yourUsername" required>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Já tem uma conta? <a href="pages-login-cliente.php">Login</a></p>
                    </div>
                    <input type="hidden" name="acao" value="registar-cliente">
                  </form>
      ...
      fetch(`https://bi.minjusdh.gov.ao/api/identityLostService/identitycardlost/queryRegisterInfo/${BI.value}`)
        ...
        .then(datas => {
          if (datas.data.FIRST_NAME) {
            ...
            document.querySelector('#yourName').value = `${datas.data.FIRST_NAME}  ${datas.data.LAST_NAME}`
            document.querySelector('#yourUsername').value = `${datas.data.CONTACT_MOBILE}`
          } else {
