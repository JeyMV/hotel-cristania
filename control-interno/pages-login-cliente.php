...
<head>
    ...
    <title>Login Cliente - SGHC</title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Login/Cliente</h5>
                                        <p class="text-center small">Insira seus dados para autenticação</p>
                                    </div>
                                    ...
                                    <form class="row g-3 needs-validation form-post" novalidate>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="text" name="email" class="form-control" id="yourUsername"
                                                    required>
                                                <div class="invalid-feedback">Forneça o seu e-mail por favor..</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">Não tem uma conta? <a href="pages-register.php">Crie
                                                    agora</a></p>
                                        </div>
                                        <input type="hidden" name="tabela" value="tb_clientes">
